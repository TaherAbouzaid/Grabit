...
const ProductCardSmall = ({ product }) => {
  ...
  return (
    <Card className="product-card-small shadow-sm product-card-small-hover" style={{ border: '1px solid #ececec', borderRadius: 12, position: 'relative', overflow: 'visible' }}>
      ...
      <div className="product-card-small-basket-icon" style={{ opacity: quantity === 0 ? 0.5 : 1 }}>
