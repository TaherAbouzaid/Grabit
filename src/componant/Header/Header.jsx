...
//               <a href="/profile" className="text-decoration-none text-secondary text-center">
//                 <BiUser size={24} />
...
//                 {user ? (
//                   <>  
//                 <a href="/Account_Order" className="dropdown-item">Checkout</a>
...
//               <a href="#fruits" className="dropdown-item">
//                 Fruits
//               </a>
//               <a href="#vegetables" className="dropdown-item">
//                 Vegetables
//               </a>
//               <a href="#meat" className="dropdown-item">
//                 Meat & Seafood
//               </a>
//               <a href="#drinks" className="dropdown-item">
//                 Drinks
//               </a>
//               <a href="#snacks" className="dropdown-item">
//                 Snacks
//               </a>
//             </div>
//           </div>
          ...
          <div className="d-flex gap-4 user-actions">
            <div className="user-hover">
              ...
              <div className="user-dropdown">
                {user ? (
                  <>
                    <a href="/Account_Order" className="dropdown-item" onClick={() => handleNavigation("/Account_Order")}>Orders</a>
            ...
            <Nav className="mx-auto">
              ...
              <div className="hover-dropdown px-3 py-3 position-relative nav-item-with-dropdown">
                ...
                <div className="dropdown-menu position-absolute">
                  ...
                  <a href="#" className="dropdown-item" onClick={() => handleNavigation("/Account_Order")}>Orders</a>
